...
def parse_args():
    ...
    parser.add_argument("--data", type = str, help = "Location of the frame files generated by generate_frames.py script")
...
def make_plots(args, dex_snr):
    ...
    ax.set_xlabel("Seconds")
    fig.savefig(f"{args.outdir}/{args.label}_timeseries.pdf")
    ############################################################
    ...
    ax.set_xlabel("SNR")
    fig.savefig(f"{args.outdir}/{args.label}/foreground_histogram.pdf")
