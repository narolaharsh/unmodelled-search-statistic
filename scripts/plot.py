...
def make_plots(args, dex_snr):
    ...
    ax = axes[0]
    ax.scatter(segment_index, dex_snr['network_snr'], label='Network statistic', s=10, color='salmon')
    ax.scatter(segment_index, dex_snr['combined_statistic'], label='Combined (network + null stream) statistic ', s=10, marker='x',
               color='black')
