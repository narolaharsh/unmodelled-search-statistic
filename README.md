...
1. Time domain strain of the supernovae signals
    1. LVK CCSN search from O1 and O2: https://arxiv.org/pdf/1908.03584
    2. Supernovae waveforms: The paper above and the following papers http://arxiv.org/abs/1106.6301 (Müller et al) http://arxiv.org/abs/1210.6674 (Ott t al), http://arxiv.org/abs/1505.05824 (Yakunin et al)
    . > "During the prompt convection, in the initial stages post bounce, GWs are emitted in the frequency range from 100-300 Hz, while at later times, GWs up to around 2 kHz can be expected [105, 106]"
