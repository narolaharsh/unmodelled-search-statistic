...
def parse_args():
    ...
    parser.add_argument("--frame-directory", type = str, help = "Location of the gwf frame files generated by generate_frames.py script")
    parser.add_argument('--detector-network', type = str, default = 'ETT', help = 'Switch of ET2L for a different design')
...
def joint_processing(frame_1, frame_2, model, scaler, delta_t, sampling_frequency, device, minimum_frequency, segment_size=8192):
    ...
    for ii in tqdm(range(len(bins) - 1)):
        seg_1, seg_2 = whitened_frame_1[bins[ii]:bins[ii+1]], whitened_frame_2[bins[ii]:bins[ii+1]]
...
def main():
    ...
    if args.detector_network=="ETT":
        ...
        dex_snr['ETSar'], dex_snr['ETLim'], dex_snr["mismatch_overlap"], dex_snr['time_stamps'] = joint_processing(frame_dictionary['ETSar'], frame_dictionary['ETLim'], model_fine_tuned, scaler, 
